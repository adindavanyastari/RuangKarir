    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 overflow-hidden border border-orange-200">
        ...
        <div class="hidden lg:flex items-center justify-center bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 p-12 relative overflow-hidden">
            ...
            <div class="text-center text-white relative z-10">
                ...
                <h3 class="text-3xl font-bold mb-4">Selamat Datang Kembali!</h3>
                <p class="text-orange-100 leading-relaxed mb-8 text-lg">
                    Masuk ke akunmu dan temukan peluang magang terbaik untuk memulai karir impianmu.
                </p>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-center space-x-3 text-orange-100">
                        ...
                        <span class="font-medium">Akses ke ribuan peluang</span>
                    </div>
                    <div class="flex items-center justify-center space-x-3 text-orange-100">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span class="font-medium">Notifikasi lowongan terbaru</span>
                    </div>
                    <div class="flex items-center justify-center space-x-3 text-orange-100">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span class="font-medium">100% gratis selamanya</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center p-8 lg:p-12">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 text-lg">Silakan masuk untuk melanjutkan ke dashboard Anda</p>
            </div>
