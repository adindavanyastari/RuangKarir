    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 overflow-hidden border border-orange-200">
        ...
        <div class="hidden lg:flex items-center justify-center bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 p-12 relative overflow-hidden">
            ...
            <div class="text-center text-white relative z-10">
                ...
                <h3 class="text-3xl font-bold mb-4">Bergabunglah dengan Komunitas Kami!</h3>
                <p class="text-orange-100 leading-relaxed mb-8 text-lg">
                    Buat akunmu sekarang dan dapatkan akses ke ribuan peluang magang dari perusahaan-perusahaan terkemuka di Indonesia.
                </p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-center space-x-3 text-orange-100">
                        ...
                        <span class="font-medium">Akses ke semua fitur</span>
                    </div>
                    <div class="flex items-center justify-center space-x-3 text-orange-100">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span class="font-medium">Notifikasi pekerjaan terbaru</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center p-8 lg:p-12">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 text-lg">Bergabunglah dengan ribuan pencari magang lainnya</p>
            </div>
            ...
            @if ($errors->any())
                <div class="bg-red-50 border-l-4 border-red-400 text-red-700 p-4 rounded-lg mb-6">
                    <div class="flex items-start space-x-2">
                        ...
                        <div>
                            <p class="font-medium mb-1">Harap perbaiki kesalahan berikut ini:</p>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="text-gray-700">
                            Saya setuju dengan
                            <a href="#" class="text-orange-600 hover:text-orange-800 font-medium transition-colors">Syarat & Ketentuan</a>
                            dan
                            <a href="#" class="text-orange-600 hover:text-orange-800 font-medium transition-colors">Kebijakan Privasi</a>
                        </label>
                    </div>
                </div>
            ...
            <a href="{{ route('google.login') }}"
               class="w-full bg-white border-2 border-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:bg-gray-50 transition-all duration-300 flex items-center justify-center space-x-3 shadow-md hover:shadow-lg mb-6 group">
                ...
                <span class="group-hover:text-gray-900 transition-colors">Lanjutkan dengan Google</span>
            </a>
            @endif
