        ...
        <div class="text-center text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    ...
                    <div class="text-orange-100">Mahasiswa Aktif</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold mb-2">{{ $totalInternships }}+</div>
                    <div class="text-orange-100">Peluang Karir</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                    <div class="text-3xl font-bold mb-2">500+</div>
                    <div class="text-orange-100">Partner Perusahaan</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-slate-600 max-w-3xl mx-auto">
                Platform untuk dosen dan HRD mencari mahasiswa berbakat berdasarkan keahlian, sertifikasi, dan pengalaman proyek
            </p>
        </div>
...
<section class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="mb-12">
            <img src="{{ asset('images/testimoni-banner.png') }}" alt="Testimoni Mahasiswa UISI" class="w-full h-[400px] object-cover rounded-2xl shadow-lg">
...
<section class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="mb-8">
            <img src="{{ asset('images/company.png') }}" alt="Partner Perusahaan" class="w-full h-[300px] object-cover rounded-2xl shadow-lg">
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center">
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('profile.my-profile') }}" class="inline-flex items-center justify-center bg-white text-orange-600 hover:bg-orange-50 font-bold px-8 py-4 text-lg rounded-full shadow-lg transition-all">
                    Lihat Profil Saya
                    <svg class="ml-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                </a>
                <a href="{{ route('peluang') }}" class="inline-flex items-center justify-center border-2 border-white text-white hover:bg-white/10 font-bold px-8 py-4 text-lg rounded-full transition-all">
                    Jelajahi Lowongan
                </a>
            </div>
