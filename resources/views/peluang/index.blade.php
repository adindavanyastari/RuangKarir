            ...
            @if ($internships->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                    @foreach ($internships as $internship)
                        <article
                            class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-orange-100 group">
                            <!-- Card Header -->
                            <div
                                class="bg-gradient-to-br from-orange-500 to-orange-600 p-5 text-white relative overflow-hidden">
                                <div
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-start justify-between mb-4">
                                        ...
                                        <div class="ml-2 flex-shrink-0">
                                            <div
                                                class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <div
                                            class="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full border border-white/30">
                                            <div class="flex items-center space-x-1">
                                                ...
                                                <span
                                                    class="font-medium text-xs">{{ ucfirst($internship->lokasi_magang) }}</span>
                                            </div>
                                        </div>
                                        <div
                                            class="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full border border-white/30">
                            ...
                            <div class="p-5">
                                ...
                                @if ($internship->benefit)
                                    <div
                                        class="mb-4 bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-lg border border-green-200">
                                        ...
                                        <p class="text-green-700 font-medium text-xs">
                                            {{ Str::limit($internship->benefit, 50) }}</p>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-orange-100 p-4">
                        ...
                        <div class="mt-3 text-center">
                            <span class="text-xs text-gray-500">
                                Showing {{ $internships->firstItem() }} to {{ $internships->lastItem() }} of
                                {{ $internships->total() }} results
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        @if (request('search'))
                            ...
                            <p class="text-gray-600 mb-6 text-sm leading-relaxed">
                                No opportunities found matching "<strong
                                    class="text-orange-600 font-medium">{{ request('search') }}</strong>".
